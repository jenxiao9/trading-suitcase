...
#
# Generated by Vivado on Fri Nov 30 00:39:04 EST 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../UART_Tester.srcs/sources_1/bd/design_1/ipshared/9c7f" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../UART_Tester.srcs/sources_1/bd/design_1/ipshared/9c7f" \
    "$ref_dir/../../../bd/design_1/ip/design_1_ControlModuleWrapper_0_0/sim/design_1_ControlModuleWrapper_0_0.v" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/afs/ece.cmu.edu/usr/dworpell/UART_Tester/UART_Tester.cache/compile_simlib/vcs"
  fi
